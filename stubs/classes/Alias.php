...
class AliasCore extends \ObjectModel
{
     ...
     */
    public static $definition = ['table' => 'alias', 'primary' => 'id_alias', 'fields' => ['search' => ['type' => self::TYPE_STRING, 'validate' => 'isValidSearch', 'required' => \true, 'size' => 255], 'alias' => ['type' => self::TYPE_STRING, 'validate' => 'isValidSearch', 'required' => \true, 'size' => 255], 'active' => ['type' => self::TYPE_BOOL, 'validate' => 'isBool']]];
    /**
