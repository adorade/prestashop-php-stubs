...
class PriceCalculator
{
     ...
     */
    public function getProductPrice($idProduct, $useTax = true, $idProductAttribute = null, $decimals = 6, $divisor = null, $onlyReduc = false, $useReduc = true, $quantity = 1, $forceAssociatedTax = false, $idCustomer = null, $idCart = null, $idAddress = null, &$specificPriceOutput = null, $withEcotax = true, $useGroupReduction = true, \Context $context = null, $useCustomerPrice = true, $idCustomization = null)
    {
    }
    /**
     ...
     * @return float Product price
     **/
    public function priceCalculation($idShop, $idProduct, $idProductAttribute, $idCountry, $idState, $zipCode, $idCurrency, $idGroup, $quantity, $useTax, $decimals, $onlyReduc, $useReduc, $withEcotax, &$specificPrice, $useGroupReduction, $idCustomer = 0, $useCustomerPrice = true, $idCart = 0, $realQuantity = 0, $idCustomization = 0)
    {
    }
    /**
     ...
     */
    public function getOrderPrice(int $orderId, int $productId, int $combinationId, bool $withTaxes, bool $useReduction, bool $withEcoTax, int $customizationId = 0): ?float
    {
    }
}
