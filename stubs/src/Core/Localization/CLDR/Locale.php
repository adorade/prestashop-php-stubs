 ...
 */
final class Locale implements \PrestaShop\PrestaShop\Core\Localization\CLDR\LocaleInterface
{
    public function __construct(\PrestaShop\PrestaShop\Core\Localization\CLDR\LocaleData $localeData)
    {
    }
    /**
